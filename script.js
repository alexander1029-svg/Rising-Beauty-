...
loadMoreBtn1.onclick = () => {
    let boxes = [...document.querrySelectorAll(".box-container-1 .box-1")];
...
loadMoreBtn2.onclick = () => {
    let boxes = [...document.querrySelectorAll(".box-container-2 .box-2")];
    for(var i = currentItem1; i < currentItem2 + 4; i++) {
        boxes[i].style.display = "inline-block";
    }
    currentItem2 += 4;
